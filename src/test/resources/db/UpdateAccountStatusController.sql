...
INSERT INTO T_ACCOUNT(id, phone_fk, category_fk, city_fk, display_name, picture_url, status, language, super_user, business, store_id, business_id, email, suspended, country)
    VALUES
